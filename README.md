...
## 목표
LG전자의 B2B 영업 성공 기회를 예측하는 모델 개발<br>
B2B 마케팅에 유의미한 영향을 주는 요인을 파악하여 솔루션 제시<br>
...
파생 변수 생성
 ...
 3. 사업 분류(비공개)로 산출된 수치 데이터를 역으로 이용하여 사업 분류 카테고리로 사용<br>
<br>범주형 변수 처리에 효과적인 CatBoost모델을 사용<br>
class_weights변수로 불균형 고려

&nbsp;  

## 결과
계약자ID 관련 변수가 매우 큰 중요도를 보임<br>
oversampling(과대표집)이 불가한 상황에서 class_weights부여가 성능 향상에 큰 기여

&nbsp;  

## 분석 과정
<img src="./images/LG_Aimers_4th(0).png" width="700" height="400"/>
<img src="./images/LG_Aimers_4th(1).png" width="700" height="400"/>
<img src="./images/LG_Aimers_4th(2).png" width="700" height="400"/>
<img src="./images/LG_Aimers_4th(3).png" width="700" height="400"/>
